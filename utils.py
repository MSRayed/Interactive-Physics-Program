...
'''
No need for this function, pymunk has built-in function for this
...
'''
This function is also not needed, but I leave it because get_mouse_on_corner
from the shape class uses it. It need a little refactor.
'''
